 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.auth.ActivateRequest,
 *   !proto.auth.ActivateResponse>}
 */
const methodDescriptor_Auth_CheckCode = new grpc.web.MethodDescriptor(
  '/auth.Auth/CheckCode',
  grpc.web.MethodType.UNARY,
  proto.auth.ActivateRequest,
  proto.auth.ActivateResponse,
  /**
   * @param {!proto.auth.ActivateRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.auth.ActivateResponse.deserializeBinary
);


/**
 * @param {!proto.auth.ActivateRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.auth.ActivateResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.auth.ActivateResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.auth.AuthClient.prototype.checkCode =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/auth.Auth/CheckCode',
      request,
      metadata || {},
      methodDescriptor_Auth_CheckCode,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.auth.ActivateResponse>}
 *     Promise that resolves to the response
 */
proto.auth.AuthPromiseClient.prototype.checkCode =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/auth.Auth/CheckCode',
      request,
